...
namespace XamarinAzureAD.Droid
{
    internal partial class Values : IServiceOperations<NativeWebApi>, IValues
    {
        ...
        /// </param>
        internal Values(NativeWebApi client)
        {
            this._client = client;
        }
